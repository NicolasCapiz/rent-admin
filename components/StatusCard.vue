  ...
  <section class="grid gap-5 md:grid-cols-2">
    ...
    <div class="rounded-lg border bg-card p-6">
      <div class="flex items-center justify-between">
        <p class="text-sm font-medium">Pagado</p>
        <span class="shrink-0">
      ...
      <p class="text-xs text-muted-foreground">20% mas que el anterior mes</p>
    </div>
    <!-- Sales -->
    <div class="rounded-lg border bg-card p-6">
      <div class="flex items-center justify-between">
        <p class="text-sm font-medium">A Pagar</p>
        <span class="shrink-0">
      ...
      <p class="text-xs text-muted-foreground">13.2% mas que el anterior mes</p>
    </div>
  </section>
</template>
